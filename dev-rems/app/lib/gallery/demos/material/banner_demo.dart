...
class _BannerDemoState extends State<BannerDemo> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final banner = MaterialBanner(
      content: Text(AppLocalizations.of(context).bannerDemoText),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).demoBannerTitle),
        actions: [
          PopupMenuButton<BannerDemoAction>(
            ...
            itemBuilder: (context) => <PopupMenuEntry<BannerDemoAction>>[
              PopupMenuItem<BannerDemoAction>(
                ...
                child:
                    Text(AppLocalizations.of(context).bannerDemoResetText),
              ),
              ...
              CheckedPopupMenuItem<BannerDemoAction>(
                ...
                child: Text(
                    AppLocalizations.of(context).bannerDemoMultipleText),
              ),
              CheckedPopupMenuItem<BannerDemoAction>(
                value: BannerDemoAction.showLeading,
                checked: _showLeading.value,
                child: Text(
                    AppLocalizations.of(context).bannerDemoLeadingText),
              ),
            ],
          ),
        ],
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            title: Text(
              AppLocalizations.of(context).starterAppDrawerItem(
