  ...
  String _title(BuildContext context) {
    switch (type) {
      case BottomSheetDemoType.persistent:
        return AppLocalizations.of(context).demoBottomSheetPersistentTitle;
      case BottomSheetDemoType.modal:
        return AppLocalizations.of(context).demoBottomSheetModalTitle;
    }
    return '';
  }
          ...
          builder: (context) => Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              ...
              child: Icon(
                Icons.add,
                semanticLabel:
                    AppLocalizations.of(context).demoBottomSheetAddLabel,
              ),
            ),
      ...
      child: Column(
        children: [
          SizedBox(
            ...
            child: Center(
              child: Text(
                AppLocalizations.of(context).demoBottomSheetHeader,
  ...
  Widget build(BuildContext context) {
    return Center(
      child: ElevatedButton(
        ...
        child: Text(AppLocalizations.of(context).demoBottomSheetButtonText),
      ),
    );
  }
}
