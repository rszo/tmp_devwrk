  ...
  String _title(BuildContext context) {
    switch (type) {
      case ChipDemoType.action:
        return AppLocalizations.of(context).demoActionChipTitle;
      case ChipDemoType.choice:
        return AppLocalizations.of(context).demoChoiceChipTitle;
      case ChipDemoType.filter:
        return AppLocalizations.of(context).demoFilterChipTitle;
      case ChipDemoType.input:
        return AppLocalizations.of(context).demoInputChipTitle;
    }
    return '';
  }
  ...
  Widget build(BuildContext context) {
    return Center(
      child: ActionChip(
        ...
        label: Text(AppLocalizations.of(context).chipTurnOnLights),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Wrap(
        children: [
          ChoiceChip(
            label: Text(AppLocalizations.of(context).chipSmall),
          ...
          ChoiceChip(
            label: Text(AppLocalizations.of(context).chipMedium),
          ...
          const SizedBox(width: 8),
          ChoiceChip(
            label: Text(AppLocalizations.of(context).chipLarge),
...
class _FilterChipDemoState extends State<_FilterChipDemo>
  ...
  Widget build(BuildContext context) {
    final chips = [
      FilterChip(
        label: Text(AppLocalizations.of(context).chipElevator),
      ...
      FilterChip(
        label: Text(AppLocalizations.of(context).chipWasher),
      ...
      FilterChip(
        label: Text(AppLocalizations.of(context).chipFireplace),
  ...
  Widget build(BuildContext context) {
    return Center(
      child: InputChip(
        ...
        label: Text(AppLocalizations.of(context).chipBiking),
      ),
    );
  }
}
