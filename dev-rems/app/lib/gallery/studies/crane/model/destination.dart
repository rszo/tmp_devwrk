...
import 'package:app/gallery/studies/crane/model/formatters.dart';
...
class FlyDestination extends Destination {
  ...
  @override
  String subtitle(BuildContext context) {
    final stopsText = AppLocalizations.of(context).craneFlyStops(stops);
...
class SleepDestination extends Destination {
  ...
  @override
  String subtitle(BuildContext context) {
    return AppLocalizations.of(context).craneSleepProperties(total);
  }
}
...
class EatDestination extends Destination {
  ...
  @override
  String subtitle(BuildContext context) {
    return AppLocalizations.of(context).craneEatRestaurants(total);
  }
}
