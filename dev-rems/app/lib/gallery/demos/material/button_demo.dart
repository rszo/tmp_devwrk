  ...
  String _title(BuildContext context) {
    switch (type) {
      case ButtonDemoType.text:
        return AppLocalizations.of(context).demoTextButtonTitle;
      case ButtonDemoType.elevated:
        return AppLocalizations.of(context).demoElevatedButtonTitle;
      case ButtonDemoType.outlined:
        return AppLocalizations.of(context).demoOutlinedButtonTitle;
      case ButtonDemoType.toggle:
        return AppLocalizations.of(context).demoToggleButtonTitle;
      case ButtonDemoType.floating:
        return AppLocalizations.of(context).demoFloatingButtonTitle;
    }
    return '';
  }
      ...
      child: Column(
        ...
        children: [
          ...
          FloatingActionButton.extended(
            ...
            label: Text(AppLocalizations.of(context).buttonTextCreate),
            onPressed: () {},
          ),
        ],
      ),
