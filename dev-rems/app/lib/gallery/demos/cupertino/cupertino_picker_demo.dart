    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: _Menu(children: [
          Text(AppLocalizations.of(context).demoCupertinoPickerDate),
          Text(
  ...
  Widget _buildTimePicker(BuildContext context) {
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: _Menu(
          children: [
            Text(AppLocalizations.of(context).demoCupertinoPickerTime),
            Text(
  ...
  Widget _buildDateAndTimePicker(BuildContext context) {
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: _Menu(
          children: [
            Text(AppLocalizations.of(context).demoCupertinoPickerDateTime),
            Flexible(
              child: Text(
  ...
  Widget _buildCountdownTimerPicker(BuildContext context) {
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: _Menu(
          children: [
            Text(AppLocalizations.of(context).demoCupertinoPickerTimer),
            Text(
              '${timer.inHours}:'
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
        ...
        middle: Text(AppLocalizations.of(context).demoCupertinoPickerTitle),
      ),
