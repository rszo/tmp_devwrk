  ...
  String _title(BuildContext context) {
    switch (type) {
      case SlidersDemoType.sliders:
        return AppLocalizations.of(context).demoSlidersTitle;
      case SlidersDemoType.rangeSliders:
        return AppLocalizations.of(context).demoRangeSlidersTitle;
      case SlidersDemoType.customSliders:
        return AppLocalizations.of(context).demoCustomSlidersTitle;
    }
    return '';
  }
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(AppLocalizations.of(context).demoSlidersDiscrete),
            ],
          ),
        ],
      ),
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text(AppLocalizations.of(context).demoSlidersContinuous),
            ],
          ),
          const SizedBox(height: 80),
          Column(
