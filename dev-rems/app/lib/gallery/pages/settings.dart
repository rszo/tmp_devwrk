...
import 'package:app/gallery/pages/about.dart' as about;
import 'package:app/gallery/pages/home.dart';
import 'package:app/gallery/pages/settings_list_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final settingsListItems = [
      ...
      SettingsListItem<CustomTextDirection>(
        title: AppLocalizations.of(context).settingsTextDirection,
        selectedOption: options.customTextDirection,
        optionsMap: LinkedHashMap.of({
          CustomTextDirection.localeBased: DisplayOption(
            AppLocalizations.of(context).settingsTextDirectionLocaleBased,
          ),
          CustomTextDirection.ltr: DisplayOption(
            AppLocalizations.of(context).settingsTextDirectionLTR,
          ),
          CustomTextDirection.rtl: DisplayOption(
            AppLocalizations.of(context).settingsTextDirectionRTL,
          ),
        }),
      ...
      SettingsListItem<Locale>(
        title: AppLocalizations.of(context).settingsLocale,
      ...
      SettingsListItem<TargetPlatform>(
        title: AppLocalizations.of(context).settingsPlatformMechanics,
