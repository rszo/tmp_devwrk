...
class _MenuDemoState extends State<MenuDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).demoMenuTitle),
    ...
    return ListTile(
      ...
      trailing: PopupMenuButton<String>(
        ...
        onSelected: (value) => showInSnackBar(
          AppLocalizations.of(context).demoMenuSelected(value),
        ),
        itemBuilder: (context) => <PopupMenuItem<String>>[
          PopupMenuItem<String>(
            value: AppLocalizations.of(context).demoMenuContextMenuItemOne,
            child: Text(
              AppLocalizations.of(context).demoMenuContextMenuItemOne,
            ),
          ),
          PopupMenuItem<String>(
            enabled: false,
            child: Text(
              AppLocalizations.of(context).demoMenuADisabledMenuItem,
            ),
          ),
          PopupMenuItem<String>(
            value:
                AppLocalizations.of(context).demoMenuContextMenuItemThree,
            child: Text(
              AppLocalizations.of(context).demoMenuContextMenuItemThree,
            ),
          ),
...
class _SectionedMenuDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      title: Text(
          AppLocalizations.of(context).demoMenuAnItemWithASectionedMenu),
      trailing: PopupMenuButton<String>(
        padding: EdgeInsets.zero,
        onSelected: (value) => showInSnackBar(
            AppLocalizations.of(context).demoMenuSelected(value)),
        itemBuilder: (context) => <PopupMenuEntry<String>>[
          PopupMenuItem<String>(
            value: AppLocalizations.of(context).demoMenuPreview,
            child: ListTile(
              leading: const Icon(Icons.visibility),
              title: Text(
                AppLocalizations.of(context).demoMenuPreview,
              ),
            ),
          ),
          PopupMenuItem<String>(
            value: AppLocalizations.of(context).demoMenuShare,
            child: ListTile(
              leading: const Icon(Icons.person_add),
              title: Text(
                AppLocalizations.of(context).demoMenuShare,
              ),
            ),
          ),
          PopupMenuItem<String>(
            value: AppLocalizations.of(context).demoMenuGetLink,
            child: ListTile(
              leading: const Icon(Icons.link),
              title: Text(
                AppLocalizations.of(context).demoMenuGetLink,
              ),
            ),
          ),
          const PopupMenuDivider(),
          PopupMenuItem<String>(
            value: AppLocalizations.of(context).demoMenuRemove,
            child: ListTile(
              leading: const Icon(Icons.delete),
              title: Text(
                AppLocalizations.of(context).demoMenuRemove,
              ),
            ),
          ),
        ],
...
class _SimpleMenuDemoState extends State<_SimpleMenuDemo> {
  ...
  String simpleValueToString(BuildContext context, SimpleValue value) => {
        SimpleValue.one: AppLocalizations.of(context).demoMenuItemValueOne,
        SimpleValue.two: AppLocalizations.of(context).demoMenuItemValueTwo,
        SimpleValue.three:
            AppLocalizations.of(context).demoMenuItemValueThree,
      }[value];
  ...
  Widget build(BuildContext context) {
    return PopupMenuButton<SimpleValue>(
      ...
      child: ListTile(
        title: Text(
            AppLocalizations.of(context).demoMenuAnItemWithASimpleMenu),
...
class _RestorableCheckedValues extends RestorableProperty<Set<CheckedValue>> {
  ...
  Iterable<String> checkedValuesToString(BuildContext context) {
    return _checked.map((value) {
      return {
        CheckedValue.one: AppLocalizations.of(context).demoMenuOne,
        CheckedValue.two: AppLocalizations.of(context).demoMenuTwo,
        CheckedValue.three: AppLocalizations.of(context).demoMenuThree,
        CheckedValue.four: AppLocalizations.of(context).demoMenuFour,
      }[value];
    });
  }
...
class _ChecklistMenuDemoState extends State<_ChecklistMenuDemo>
  ...
  void showCheckedMenuSelections(BuildContext context, CheckedValue value) {
    ...
    widget.showInSnackBar(
      AppLocalizations.of(context).demoMenuChecked(
  ...
  Widget build(BuildContext context) {
    return ListTile(
      title: Text(
        AppLocalizations.of(context).demoMenuAnItemWithAChecklistMenu,
      ),
