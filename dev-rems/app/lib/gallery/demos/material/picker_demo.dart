  ...
  String get _title {
    switch (widget.type) {
      case PickerDemoType.date:
        return AppLocalizations.of(context).demoDatePickerTitle;
      case PickerDemoType.time:
        return AppLocalizations.of(context).demoTimePickerTitle;
      case PickerDemoType.range:
        return AppLocalizations.of(context).demoDateRangePickerTitle;
        break;
    }
    return '';
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text(
                      AppLocalizations.of(context).demoPickersShowPicker,
                    ),
                  )
                ],
              ),
