...
List<TravelDestination> destinations(BuildContext context) => [
      TravelDestination(
        ...
        title:
            AppLocalizations.of(context).cardsDemoTravelDestinationTitle1,
        description: AppLocalizations.of(context)
            .cardsDemoTravelDestinationDescription1,
        city: AppLocalizations.of(context).cardsDemoTravelDestinationCity1,
      ...
      TravelDestination(
        ...
        assetPackage: _kGalleryAssetsPackage,
        title:
            AppLocalizations.of(context).cardsDemoTravelDestinationTitle2,
        description: AppLocalizations.of(context)
            .cardsDemoTravelDestinationDescription2,
        city: AppLocalizations.of(context).cardsDemoTravelDestinationCity2,
        location: AppLocalizations.of(context)
      ...
      TravelDestination(
        ...
        assetPackage: _kGalleryAssetsPackage,
        title:
            AppLocalizations.of(context).cardsDemoTravelDestinationTitle3,
        description: AppLocalizations.of(context)
    ...
    return SafeArea(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            SectionTitle(
                title: AppLocalizations.of(context).cardsDemoTappable),
            SizedBox(
              height: height,
              child: Card(
    ...
    return SafeArea(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            SectionTitle(
                title: AppLocalizations.of(context).cardsDemoSelectable),
            SizedBox(
              height: height,
              child: Card(
                // This ensures that the Card's children (including the ink splash) are clipped correctly.
          ...
          Padding(
            ...
            child: OverflowBar(
              ...
              children: [
                TextButton(
                  onPressed: () {},
                  child: Text(AppLocalizations.of(context).demoMenuShare,
                      semanticsLabel: AppLocalizations.of(context)
                          .cardsDemoShareSemantics(destination.title)),
                ),
                TextButton(
                  onPressed: () {},
                  child: Text(AppLocalizations.of(context).cardsDemoExplore,
                      semanticsLabel: AppLocalizations.of(context)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).demoCardTitle),
      ),
      body: Scrollbar(
        child: ListView(
