...
import 'package:app/gallery/studies/crane/backlayer.dart';
import 'package:app/gallery/studies/crane/border_tab_indicator.dart';
import 'package:app/gallery/studies/crane/colors.dart';
import 'package:app/gallery/studies/crane/header_form.dart';
import 'package:app/gallery/studies/crane/item_cards.dart';
import 'package:app/gallery/studies/crane/model/data.dart';
              ...
              child: Padding(
                ...
                child: Theme(
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      Tab(text: AppLocalizations.of(context).craneFly),
                      Tab(text: AppLocalizations.of(context).craneSleep),
                      Tab(text: AppLocalizations.of(context).craneEat),
                    ],
                  ),
                ),
              ),
