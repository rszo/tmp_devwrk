  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).demoBottomAppBarTitle),
      ),
      body: ListView(
        ...
        children: [
          SwitchListTile(
            title: Text(
              AppLocalizations.of(context).demoFloatingButtonTitle,
            ),
            value: _showFab.value,
            onChanged: _onShowFabChanged,
          ),
          SwitchListTile(
            title: Text(AppLocalizations.of(context).bottomAppBarNotch),
            value: _showNotch.value,
            onChanged: _onShowNotchChanged,
          ),
          Padding(
            padding: const EdgeInsets.all(16),
            child: Text(AppLocalizations.of(context).bottomAppBarPosition),
          ),
          RadioListTile<int>(
            title: Text(
              AppLocalizations.of(context).bottomAppBarPositionDockedEnd,
            ),
            value: 0,
          ...
          RadioListTile<int>(
            title: Text(
              AppLocalizations.of(context).bottomAppBarPositionDockedCenter,
            ),
            value: 1,
            groupValue: _currentFabLocation.value,
            onChanged: _onFabLocationChanged,
          ...
          RadioListTile<int>(
            title: Text(
              AppLocalizations.of(context).bottomAppBarPositionFloatingEnd,
            ),
            value: 2,
            groupValue: _currentFabLocation.value,
            onChanged: _onFabLocationChanged,
      ...
      floatingActionButton: _showFab.value
          ? FloatingActionButton(
              onPressed: () {},
              tooltip: AppLocalizations.of(context).buttonTextCreate,
      ...
      child: IconTheme(
        ...
        child: Row(
          children: [
            ...
            IconButton(
              tooltip: AppLocalizations.of(context).starterAppTooltipSearch,
              icon: const Icon(Icons.search),
              onPressed: () {},
            ),
            IconButton(
              tooltip:
                  AppLocalizations.of(context).starterAppTooltipFavorite,
