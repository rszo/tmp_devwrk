...
import 'package:app/gallery/data/gallery_options.dart';
...
class _DialogDemoState extends State<DialogDemo> with RestorationMixin {
  ...
  void _showInSnackBar(String value) {
    ...
    if (value != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            AppLocalizations.of(context).dialogSelectedOption(value),
          ),
        ),
      );
    }
  ...
  String _title(BuildContext context) {
    switch (widget.type) {
      case DialogDemoType.alert:
        return AppLocalizations.of(context).demoAlertDialogTitle;
      case DialogDemoType.alertTitle:
        return AppLocalizations.of(context).demoAlertTitleDialogTitle;
      case DialogDemoType.simple:
        return AppLocalizations.of(context).demoSimpleDialogTitle;
      case DialogDemoType.fullscreen:
        return AppLocalizations.of(context).demoFullscreenDialogTitle;
    }
    return '';
  }
  ...
  static Route<String> _alertDialogDemoRoute(
    ...
    return DialogRoute<String>(
      ...
      builder: (context) => ApplyTextOptions(
        child: AlertDialog(
          content: Text(
            AppLocalizations.of(context).dialogDiscardTitle,
            style: dialogTextStyle,
          ),
          actions: [
            _DialogButton(text: AppLocalizations.of(context).dialogCancel),
            _DialogButton(text: AppLocalizations.of(context).dialogDiscard),
          ],
        ),
      ),
    );
  ...
  static Route<String> _alertDialogWithTitleDemoRoute(
    ...
    return DialogRoute<String>(
      ...
      builder: (context) => ApplyTextOptions(
        child: AlertDialog(
          title: Text(AppLocalizations.of(context).dialogLocationTitle),
          content: Text(
            AppLocalizations.of(context).dialogLocationDescription,
            style: dialogTextStyle,
          ),
          actions: [
            _DialogButton(
                text: AppLocalizations.of(context).dialogDisagree),
            _DialogButton(text: AppLocalizations.of(context).dialogAgree),
          ],
        ),
      ),
    );
  ...
  static Route<String> _simpleDialogDemoRoute(
    ...
    return DialogRoute<String>(
      ...
      builder: (context) => ApplyTextOptions(
        child: SimpleDialog(
          title: Text(AppLocalizations.of(context).dialogSetBackup),
          children: [
            _DialogDemoItem(
            ...
            _DialogDemoItem(
              ...
              text: AppLocalizations.of(context).dialogAddAccount,
          ...
          builder: (context) => Scaffold(
            ...
            body: Center(
              child: ElevatedButton(
                ...
                child: Text(AppLocalizations.of(context).dialogShow),
              ),
            ),
          ),
        );
  ...
  Widget build(BuildContext context) {
    ...
    return MediaQuery.removePadding(
      ...
      child: ApplyTextOptions(
        child: Scaffold(
          appBar: AppBar(
            title: Text(AppLocalizations.of(context).dialogFullscreenTitle),
            actions: [
              TextButton(
                onPressed: () {
                ...
                child: Text(
                  AppLocalizations.of(context).dialogFullscreenSave,
          ...
          body: Center(
            child: Text(
              AppLocalizations.of(context).dialogFullscreenDescription,
            ),
          ),
        ),
      ),
