...
import 'package:app/gallery/codeviewer/code_style.dart';
...
import 'package:app/gallery/feature_discovery/feature_discovery.dart';
import 'package:app/gallery/layout/adaptive.dart';
import 'package:app/gallery/pages/splash.dart';
import 'package:app/gallery/themes/gallery_theme_data.dart';
import 'package:app/gallery/themes/material_demo_theme_data.dart';
    ...
    final appBar = AppBar(
      ...
      actions: [
        if (_hasOptions)
          IconButton(
            icon: FeatureDiscovery(
              title: AppLocalizations.of(context).demoOptionsFeatureTitle,
            ...
            tooltip: AppLocalizations.of(context).demoOptionsTooltip,
            onPressed: () => _handleTap(_DemoState.options),
          ),
        IconButton(
          icon: const Icon(Icons.info),
          tooltip: AppLocalizations.of(context).demoInfoTooltip,
        ...
        IconButton(
          ...
          tooltip: AppLocalizations.of(context).demoCodeTooltip,
        ...
        IconButton(
          ...
          tooltip: AppLocalizations.of(context).demoDocumentationTooltip,
          color: iconColor,
        ...
        if (isDesktop)
          IconButton(
            ...
            tooltip: AppLocalizations.of(context).demoFullscreenTooltip,
