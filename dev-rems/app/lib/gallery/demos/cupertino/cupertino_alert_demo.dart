  ...
  String _title(BuildContext context) {
    switch (widget.type) {
      case AlertDemoType.alert:
        return AppLocalizations.of(context).demoCupertinoAlertTitle;
      case AlertDemoType.alertTitle:
        return AppLocalizations.of(context)
            .demoCupertinoAlertWithTitleTitle;
      case AlertDemoType.alertButtons:
        return AppLocalizations.of(context).demoCupertinoAlertButtonsTitle;
      case AlertDemoType.alertButtonsOnly:
        return AppLocalizations.of(context)
            .demoCupertinoAlertButtonsOnlyTitle;
      case AlertDemoType.actionSheet:
        return AppLocalizations.of(context).demoCupertinoActionSheetTitle;
    }
    return '';
  }
    ...
    return CupertinoDialogRoute<String>(
      ...
      builder: (context) => ApplyTextOptions(
        child: CupertinoAlertDialog(
          title: Text(AppLocalizations.of(context).dialogDiscardTitle),
          actions: [
            CupertinoDialogAction(
              ...
              onPressed: () {
                Navigator.of(
                  context,
                ).pop(AppLocalizations.of(context).cupertinoAlertDiscard);
              },
              child: Text(
                AppLocalizations.of(context).cupertinoAlertDiscard,
              ),
            ),
            CupertinoDialogAction(
              ...
              onPressed: () => Navigator.of(
                ...
                AppLocalizations.of(context).cupertinoAlertCancel,
              ),
              child: Text(
                AppLocalizations.of(context).cupertinoAlertCancel,
              ),
  ...
  static Route<String> _alertWithTitleDialog(
    ...
    return CupertinoDialogRoute<String>(
      ...
      builder: (context) => ApplyTextOptions(
        child: CupertinoAlertDialog(
          title: Text(
            AppLocalizations.of(context).cupertinoAlertLocationTitle,
          ),
          content: Text(
            AppLocalizations.of(context).cupertinoAlertLocationDescription,
          ),
          actions: [
            CupertinoDialogAction(
              onPressed: () => Navigator.of(
                ...
                AppLocalizations.of(context).cupertinoAlertDontAllow,
              ),
              child: Text(
                AppLocalizations.of(context).cupertinoAlertDontAllow,
              ),
            ...
            CupertinoDialogAction(
              onPressed: () => Navigator.of(
                ...
                AppLocalizations.of(context).cupertinoAlertAllow,
              ),
              child: Text(
                AppLocalizations.of(context).cupertinoAlertAllow,
              ),
    ...
    return CupertinoDialogRoute<String>(
      ...
      builder: (context) => ApplyTextOptions(
        child: CupertinoDessertDialog(
          title: Text(
            AppLocalizations.of(context).cupertinoAlertFavoriteDessert,
          ),
          content: Text(
            AppLocalizations.of(context).cupertinoAlertDessertDescription,
          ),
        ),
      ),
    );
          ...
          actions: [
            CupertinoActionSheetAction(
              onPressed: () => Navigator.of(
                ...
                AppLocalizations.of(context).cupertinoAlertCheesecake,
              ),
              child: Text(
                AppLocalizations.of(context).cupertinoAlertCheesecake,
              ),
            ...
            CupertinoActionSheetAction(
              onPressed: () => Navigator.of(
                ...
                AppLocalizations.of(context).cupertinoAlertTiramisu,
              ),
              child: Text(
                AppLocalizations.of(context).cupertinoAlertTiramisu,
              ),
            ...
            CupertinoActionSheetAction(
              onPressed: () => Navigator.of(
                ...
                AppLocalizations.of(context).cupertinoAlertApplePie,
              ),
              child: Text(
                AppLocalizations.of(context).cupertinoAlertApplePie,
              ),
              ...
              Expanded(
                child: Center(
                  child: CupertinoButton.filled(
                    ...
                    child: Text(
                      AppLocalizations.of(context).cupertinoShowAlert,
                    ),
                  ),
                ),
              ),
        ...
        CupertinoDialogAction(
          onPressed: () {
            Navigator.of(
              ...
              AppLocalizations.of(context).cupertinoAlertChocolateBrownie,
            );
          },
          child: Text(
            AppLocalizations.of(context).cupertinoAlertChocolateBrownie,
